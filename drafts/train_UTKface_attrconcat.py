"""
Train ResNet18AttrConcat on UTKFace for Binary Age Classification
=================================================================
任务: 年龄二分类, [0, 35) vs [35, +inf)
      把 sex/race 的 embedding broadcast 成空间通道, 和图像 concat 作为输入。

使用方法:
    1. 从 Kaggle 下载 CSV 版 UTKFace 数据集:
       https://www.kaggle.com/datasets/nipunarora8/age-gender-and-ethnicity-face-data-csv
    2. 解压得到 age_gender.csv, 放到 ./data/ 目录下
    3. python train_utkface_attrconcat.py
"""
...
from ResNet18_attrconcat import ResNet18AttrConcat
...
def main():
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "resnet18_attrconcat_utkface_best.pth")
            print(f"  ↳ New best val acc, saved.")
        print("-" * 60)

    # 最终用 best checkpoint 在 test set 上跑
    print("\nLoading best checkpoint and evaluating on test set...")
    model.load_state_dict(torch.load("resnet18_attrconcat_utkface_best.pth"))
