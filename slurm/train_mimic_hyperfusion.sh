...
#SBATCH --gres=gpu:1
#SBATCH --output=/vol/biomedic2/bglocker_studproj/zc125/logs/train_mimic_hyperfusion.%N.%A_%a.log
#SBATCH --time=0-23:59:00                                           # 早停上限 30 epoch；单 epoch 与 baseline/HyperHead 同量级
#SBATCH --job-name=train_mimic_hyperfusion
...
python /vol/biomedic2/bglocker_studproj/zc125/code/hypernetworks_MSc_IP/src/training/train_mimic_hyperfusion.py --seed "$SEED"
