...
#          --output=/vol/biomedic2/bglocker_studproj/zc125/logs/mimic_erm_cvsearch.%N.%A_%a.log \
#          --export=ALL,PY_SCRIPT=/vol/biomedic2/bglocker_studproj/zc125/code/hypernetworks_MSc_IP/src/training/train_mimic_resnet18.py,SWAD=1 \
