...
#SBATCH --gres=gpu:1
#SBATCH --output=/vol/biomedic2/bglocker_studproj/zc125/logs/train_mimic_hyperadapt.%N.%A_%a.log
#SBATCH --time=1-12:00:00                                           # 早停上限 30 epoch；HyperAdapt 单 epoch 比 baseline 慢，留足余量
#SBATCH --job-name=train_mimic_hyperadapt
...
#    若 gpus48 上仍 OOM，可在 configs/mimic_cxr_baseline.yaml 调小 training.batch_size（训练策略其余不变）。
...
python /vol/biomedic2/bglocker_studproj/zc125/code/hypernetworks_MSc_IP/src/training/train_mimic_hyperadapt.py --seed "$SEED"
