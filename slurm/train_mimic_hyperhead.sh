...
#SBATCH --gres=gpu:1
#SBATCH --output=/vol/biomedic2/bglocker_studproj/zc125/logs/train_mimic_hyperhead.%N.%A_%a.log
#SBATCH --time=1-12:00:00                                           # 早停上限 30 epoch；留出余量覆盖单 epoch 用时
#SBATCH --job-name=train_mimic_hyperhead
...
python /vol/biomedic2/bglocker_studproj/zc125/code/hypernetworks_MSc_IP/src/training/train_mimic_hyperhead.py --seed "$SEED"
